...
<body>
	<div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <a class="brand" href="#">PHP TwinMee</a>
        </div>
      </div>
    </div>
	...
	<div class="container">
		...
		<form method="POST" class="form-horizontal" action="index.php"> 
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="voice">
						<?php echo $twinmee->voiceList(isset($_POST['voice']) ? $_POST['voice'] : null); ?>
					</select>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
					<div class="btn-group">
						<button type="submit" name="listen" class="btn btn-danger">Écouter</button>
						<button type="submit" name="download" class="btn btn-danger">Télécharger</button>
					</div>
				</div>
			</div>
			<div class="control-group">
